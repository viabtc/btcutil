...
import (
	...
	"github.com/viabtc/dogeutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    dogeutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() dogeutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value dogeutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = dogeutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = dogeutil.NewTxFromBytes(testSimpleCoinTxBytes)
