...
// Tx returns a wrapped transaction (dogeutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (dogeutil.Tx) for all
...
// instead provides easy access to wrapped versions (dogeutil.Tx) of them.
